import{_ as s,S as n,N as a,Q as e}from"./chunks/framework.f9c570e8.js";const d=JSON.parse('{"title":"目录结构","description":"","frontmatter":{},"headers":[],"relativePath":"guide/web/start_web/catalogue_web.md","filePath":"guide/web/start_web/catalogue_web.md","lastUpdated":null}'),l={name:"guide/web/start_web/catalogue_web.md"},p=e(`<h1 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h1><h2 id="simpleadmin前端目录说明-📚" tabindex="-1">SimpleAdmin前端目录说明 📚 <a class="header-anchor" href="#simpleadmin前端目录说明-📚" aria-label="Permalink to &quot;SimpleAdmin前端目录说明 📚&quot;">​</a></h2><div class="language-txt line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki github-dark"><code><span class="line"><span style="color:#e1e4e8;">web</span></span>
